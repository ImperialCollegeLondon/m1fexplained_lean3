...
begin
  use D,
  split,
  simp_rw [set.mem_insert_iff, eq_self_iff_true, true_or, or_true],
  use E,
  split,
  simp_rw [set.mem_insert_iff, set.mem_singleton, or_true, hD, E],
  simp only [set.subset_singleton_iff, set.mem_singleton_iff, forall_eq, zero_ne_one, not_false_iff, one_ne_zero, and_self],
end
